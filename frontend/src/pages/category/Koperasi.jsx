...
import { FaHandshake, FaSearch, FaBoxOpen } from "react-icons/fa";
...
export default function Koperasi() {
  ...
  useEffect(() => {
    api.get("/products?category=Koperasi")
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12 relative z-20">
         <div className="flex justify-center mb-8 md:mb-10">
             <div className="relative w-full max-w-md">
                <input 
                    type="text" placeholder="Cari produk Koperasi..." 
                    className="w-full pl-10 md:pl-12 pr-4 py-2.5 md:py-3 rounded-full border border-gray-200 shadow-sm focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base"
